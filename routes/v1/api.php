...
use App\Http\Controllers\Api\V1\CalendarCategoryController;
...
Route::group(['middleware' => 'auth:api'], function () {
    Route::apiResource('calendar-categories', CalendarCategoryController::class)->names('calendar-categories');
});
